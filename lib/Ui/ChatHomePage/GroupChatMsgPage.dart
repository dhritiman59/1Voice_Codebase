...
class GroupChatMsgPage extends StatefulWidget {
  ...
  final String caseId,caseTitleForGroupChat,senderId,caseImage,senderName;

  GroupChatMsgPage({this.caseId,this.caseTitleForGroupChat,this.caseImage,this.senderId,this.senderName});

  @override
  _GroupChatMsgPageState createState() => _GroupChatMsgPageState();
}
...
class _GroupChatMsgPageState extends State<GroupChatMsgPage> {
  ...
  String compareMessageDatehihi="";
  String compareMessageDate2="";
  bool hihi = false;
  bool hihi1 = false;
  ...
  void initState() {
    ...
    print(widget.caseId+ '+++++++++++++' + widget.caseTitleForGroupChat + widget.caseImage+ '+++++++++++++' + widget.senderId + widget.senderName+ '+++++++++++++');

    _chatPageBloc.getUserDetails();
    _firebaseMessagingDetails.setGroupChatListId(
        caseId: widget.caseId,
        caseTitleForGroupChat: widget.caseTitleForGroupChat,
        caseImage: widget.caseImage,
                                ...
                                Container(
                                  ...
                                  child: ClipRRect(
                                      ...
                                      child: CircleAvatar(radius: 50,
                                          backgroundColor: Colors.white,
                                          child: ClipOval(
                                            child: Image.asset(widget.caseImage,),))
                                  ),
                                ):
                                ClipRRect(
                                  borderRadius: BorderRadius.circular(20.0),
                                  child: displayProfilePic(widget.caseTitleForGroupChat),
                                ),
                              ),
                            ),
                              ...
                              child: Column(
                                children: [
                                  Padding(
                                    ...
                                    child: Text(widget.caseTitleForGroupChat,
                                        maxLines: 1,
  ...
  Widget ChatViewListOfAllMessages()
  {
    return Container(
      ...
      child:StreamBuilder(
        stream: _firebaseMessagingDetails.chaMsgStream,
            ...
            if (snapshot.data.length == 0) {
              ...
              return SingleChildScrollView(
                ...
                child: ListView.builder(
                  ...
                  //controller: _firebaseMessagingDetails.chatListController,
                  ...
                  itemBuilder: (context, index) {
                    ...
                    if(snapshot.data.length==0 || snapshot.data.length!=1)
                    {
                      ...
                      {
                        valuedateTodayTommorow = checkDate(checkingdate);
                        print("222222222222222222222222222222" + '$valuedateTodayTommorow');
                        valuedate = valuedateTodayTommorow == 'TODAY' || valuedateTodayTommorow == 'YESTERDAY' ?
                        valuedateTodayTommorow
                        : snapshot.data[index].dateGroupData;
                      }
                      else
                    ...
                    return ListTile(
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          ? SenderUi(senderMsg: snapshot.data[index].message.toString(),
                              sendername: snapshot.data[index].senderName.toString(),
                              messageTime:messageTime)
                          : ReciverUi(reciverMsg: snapshot.data[index]
                              .message.toString(), recivername: snapshot.data[index]
                              .senderName.toString(), messageTime:messageTime),
          ...
          InkWell(
            ...
            onTap: () {
              ...
              if(_txtCtrl.text==""||_txtCtrl.text.isEmpty)
                ...
                {
                  _firebaseMessagingDetails.sendMessageGroupChat(
                      _txtCtrl.text,
                      widget.caseId,
                      widget.caseTitleForGroupChat,
                      widget.caseImage,
